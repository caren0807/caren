        ...
        <li class="nav-item active">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item active" href="barang.php">RSI Jember</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h3 mb-0 text-gray-800">Peminjaman Barang Politeknik Jember</h2>
          </div>
                  ...
                  <tbody>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='proses_keranjang.php?op=tambah&id=" . $row['no'] . "' class='btn btn-sm mr-1' style='background-color: #8ab6d6; color: #000000;'>Pilih</a>";
