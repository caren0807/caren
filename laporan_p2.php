...
<head>
  ...
  <title>Transaksi - RSI sidoarjo</title>
            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                  <!-- Tombol Kembali -->
                  <a href="home2.php"><button class="btn btn-sm float-right" style="background-color: #8ab6d6; color: #000000;">Kembali</button></a>
                  <a href="cetak.php"><button class="btn btn-sm float-right" style="background-color: #8ab6d6; color: #000000;">CETAK</button></a>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container">
                      <h1>Laporan Pengembalian Barang RSI sidoarjo</h1>
...
$sql = "SELECT * FROM transaksi_sidoarjo WHERE status_pengembalian = 'sudah'";
