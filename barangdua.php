    ...
    background: linear-gradient(to right, #8ab4f8, #a2c2e0); /* Pastel blue with darker shades */
      ...
      <body class="bg-gradient-primary">
        ...
        <li class="nav-item active ">
          <a class="nav-link active " href="barangdua.php">
            <i class="fas fa-fw fa-box"></i>
            <span>Peminjaman Barang</span></a>
        </li>

        <li class="nav-item active ">
          <a class="nav-link active " href="pengembalian2.php">
            <i class="fas fa-fw fa-box"></i>
                  ...
                  <tbody>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<a href='proses_keranjang2.php?op=tambah&id=" . $row['no'] . "' class='btn btn-sm mr-1' style='background-color: #8ab6d6; color: #000000;'>Pilih</a>";
