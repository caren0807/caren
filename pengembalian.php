...
$nama_query = "SELECT DISTINCT nama_peminjam FROM transaksi_jember WHERE nama_peminjam LIKE ? AND status_pengembalian = 'belum'";
...
if (isset($_POST['transaksi_id'])) {
  ...
  $update_query = "UPDATE transaksi_jember SET status_pengembalian = 'sudah' WHERE id_barang = ?";
  ...
  <div class="container mt-5">
    ...
    <form id="searchForm" method="GET" action="" class="mb-4">
      <div class="input-group">
        ...
        <button type="submit" class="btn" style="background-color: #8ab6d6; color: #000000;">Cari</button>
                ...
                while ($row = $result_nama->fetch_assoc()) {
                  ...
                  echo "<td>
                          <form method='POST' action=''>
                             ...
                             <button type='submit' name='pilih' class='btn btn-sm' style='background-color: #8ab6d6; color: #000000;'>Pilih</button>
    ...
    <!-- Tombol Kembali -->
    <a href="barang.php" class="btn mt-4" style="background-color: #a9a9a9; color: #000000;">Kembali</a>
