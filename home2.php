  ...
  <body class="bg-gradient-primary">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="home2.php">
          ...
          <span>Rekayasa Siutem Informasi Sidoarjo</span></a>
  ...
  <!-- Other boxes... -->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
              <h3 class="m-0 font-weight-bold text-dark">Rekayasa Sistem Informasi Sidoarjo</h3>
             
              <a href="tambahdua.php?op=tambah" class="btn btn-sm float-right" style="background-color: #8ab6d6; color: #000000;">Tambah Data</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='tambahdua.php?action=edit2&id=" . $row['no'] . "' class='btn' style='background-color: #a3c2e6; color: #000000; border-color: #a3c2e6;' class='btn btn-sm mr-1'>Edit</a>";
                        echo "<a href='delete2.php?op=delete&id=" . $row['no'] . "'class='btn' style='background-color: #f4a1a1; color: #000000; border-color: #f4a1a1;' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");'>Delete</a>";
                        echo "</td>";
